...
<nav id="nav">  
  <a href="#" class="nav-logo"><img src="logo.jpg" alt="Tempo D'or"></a>  
  <ul class="nav-links">  
...
<section class="hero">  
  <div class="hero-grid">  
    ...
    <div class="hero-img-wrap">  
      <img src="hero_card.png" alt="Tempo D'or">  
    </div>  
  </div>  
</section>  
...
<footer id="footer">  
  <div class="footer-grid">  
    <div>  
      <a href="#" class="footer-logo"><img src="logo.jpg" alt="Tempo D'or" style="filter:brightness(0) invert(1);opacity:0.85;"></a>  
...
<div class="side-menu" id="sideMenu">  
  <div class="side-head">  
    <img src="logo.jpg" alt="Tempo D'or">  
...
<script>  
const IMGS = {  
  poedagar:'poedagar.jpg',  
  curren_black:'curren_black.jpg',  
  curren_white:'curren_white.jpg',  
  curren_blue:'curren_blue.jpg',  
  curren_skyblue:'curren_skyblue.jpg',  
  rolex:'rolex.jpg',  
  hk11:'hk11.jpg',  
};  
