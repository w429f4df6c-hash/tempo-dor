...
.nav-logo img{height:50px;object-fit:contain;background:transparent;}  
...
.footer-logo img{height:50px;object-fit:contain;display:block;margin-bottom:12px;background:transparent;}  
...
<nav id="nav">  
  <a href="#" class="nav-logo"><img src="logo.png" alt="Tempo D'or" style="background:transparent;"></a>  
  <ul class="nav-links">  
...
<footer id="footer">  
  <div class="footer-grid">  
    <div>  
      <a href="#" class="footer-logo"><img src="logo.png" alt="Tempo D'or" style="filter:brightness(0) invert(1);opacity:0.9;background:transparent;"></a>  
...
<div class="side-menu" id="sideMenu">  
  <div class="side-head">  
    <img src="logo.png" alt="Tempo D'or" style="background:transparent;">  
